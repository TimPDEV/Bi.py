...
#Для доработки кода можно добавить параметр с названием пары в запросе, а затем передавать его в функцию при вызове. Также можно добавить переменную, хранящую список всех доступных пар, для того чтобы пройти циклом по всем парам и проверять цену для каждой.
